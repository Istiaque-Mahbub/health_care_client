...
import DashboardMobileSidebar from "./DashboardModelSidebar";
...
export default function DashboardNavbarContent({ userInfo, navItems, dashboardHome }: DashboardNavbarContentProps) {
